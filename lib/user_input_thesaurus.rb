...
class Thesaurus
  attr_accessor :main_menu_1_words, :main_menu_2_words, :main_menu_3_words, :main_menu_4_words, :main_menu_5_words, :main_menu_0_words, :display_menu_1_words, :display_menu_2_words, :display_menu_3_words, :display_menu_0_words
  ...
  def initialize
    ...
    # || self.thesaurus.main_menu_1_words.include?(user_input.downcase)
